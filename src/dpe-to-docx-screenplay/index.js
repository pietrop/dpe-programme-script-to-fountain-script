 ...
 * @params {*} param.events - dpe programmes scrirpt paper edit/paper-cuts events attribute
 * @returns buffer, to be used server side with node, with fs, or client side with js to save as file
 */
function dpeToDocxScreenplay({ title, events }) {
  return new Promise((resolve, reject) => {
    ...
    // and then return buffer
    // module calling this can then use fs if in node context or
    // save/download if browser
    Packer.toBuffer(doc)
      .then((buffer) => {
...
module.exports = dpeToDocxScreenplay;

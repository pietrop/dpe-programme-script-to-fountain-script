/**
 * Fountain.js modified note so that instead of using html comment
 *  <!-- --> it uses <div class="comment"></div> with `.comment` css style
 ```
 .comment {
    color: #cccccc;
    font-style: italic;
 ...
 ```
 * 
 * from https://fountainloader.com
 *
 * https://github.com/thombruce/fountain.js/blob/master/fountain.js
 */
(function () {
  'use strict';
  ...
  var parse = function (script, toks, callback) {
    ...
    while (i--) {
      ...
      switch (token.type) {
        ...
        case 'note':
          html.push('<div class="comment">' + token.text + '</div>');
          break;
        case 'boneyard_begin':
          html.push('<!-- ');
          break;
